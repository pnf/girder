...
(defn cmds-redis [] [(cmd-getjar)
                     (str "bin/redis-server")])
...
(def c-dist (bring-up-spots my-req 1 (cmds-dist "pool" redis-ip 100 redis-log) :subnet my-sub-private :itype "t1.micro" :price 0.01 :key "girder" :minutes 100))
